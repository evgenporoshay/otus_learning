...
$MESS["CT_BSP_AND"] = "і";
$MESS["CT_BSP_AND_ALT"] = "Оператор <i>логічне \"і\"</i> передбачається,що  його можна пропускати: запит \"контактна інформація\" повністю еквівалентний запиту \"контактна і інформація\".";
$MESS["CT_BSP_BRACKETS_ALT"] = "<i>Круглі дужки</i> задають порядок дії логічних операторів.";
$MESS["CT_BSP_CORRECT_AND_CONTINUE"] = "Виправте пошукову фразу та повторіть пошук.";
$MESS["CT_BSP_DATES_ALL"] = "всі";
...
$MESS["CT_BSP_FOUND_MSGVER_1"] = "Знайдено: #AMOUNT#";
...
$MESS["CT_BSP_NOTHING_TO_FOUND_MSGVER_1"] = "На жаль, за вашим пошуковим запитом нічого не знайдено.";
$MESS["CT_BSP_NOT_ALT"] = "Оператор <i>логічне \"не\"</i> обмежує пошук сторінок, що не містять слово, вказане після оператора.";
